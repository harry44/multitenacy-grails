...
<html>
    ...
    <body>
        ...
        <div id="show-companyProfile" class="content scaffold-show" role="main">
            ...
            <f:display bean="companyProfile" />
            <g:form resource="${this.companyProfile}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.companyProfile}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
