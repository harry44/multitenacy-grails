...
public class CheckAvailabilityResponse {
    ...
    @XmlElementRef(name = "CheckAvailabilityResult", namespace = "http://BBS.EPayment", type = JAXBElement.class, required = false)
    protected JAXBElement<String> checkAvailabilityResult;
     ...
     *     
     */
    public JAXBElement<String> getCheckAvailabilityResult() {
     ...
     *     
     */
    public void setCheckAvailabilityResult(JAXBElement<String> value) {
