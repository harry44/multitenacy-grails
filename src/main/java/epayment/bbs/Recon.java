 ...
 *         &lt;element name="request" type="{http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary}ReconRequest" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Recon {
    ...
    @XmlElementRef(name = "request", namespace = "http://BBS.EPayment", type = JAXBElement.class, required = false)
    protected JAXBElement<ReconRequest> request;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ReconRequest }{@code >}
     *     
     */
    public JAXBElement<ReconRequest> getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(JAXBElement<ReconRequest> value) {
        this.request = value;
    }
