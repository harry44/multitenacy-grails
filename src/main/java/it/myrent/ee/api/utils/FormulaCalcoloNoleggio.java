...
public class FormulaCalcoloNoleggio {
    ...
    /**
     * (Session sx, MROldTariffa tariffa, boolean ivaInclusa, double aliquotaIva, double importoTariffa, double numeroGiorni, boolean giornoExtra) throws HibernateException
