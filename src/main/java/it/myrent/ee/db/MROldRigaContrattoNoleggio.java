...
public class MROldRigaContrattoNoleggio implements it.aessepi.utils.db.PersistentInstance, MROldRigaDocumento {
    ...
    /** default constructor */
    public MROldRigaContrattoNoleggio() {
        setTempoKm(false);
        setTempoExtra(false);
        setFranchigia(false);
    }

    public MROldRigaContrattoNoleggio(MROldRigaDocumentoFiscale row, MROldContrattoNoleggio agreement) {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof MROldRigaContrattoNoleggio)) {
            return false;
        }
        MROldRigaContrattoNoleggio castOther = (MROldRigaContrattoNoleggio) other;
