...
public class MROldRigaDocumentoFiscale implements it.aessepi.utils.db.PersistentInstance, MROldRigaDocumento {
    ...
    /** default constructor */
    public MROldRigaDocumentoFiscale() {
        setTempoKm(false);
        setTempoExtra(false);
        setFranchigia(false);
    }
    ...
    public String toString() {
        String fatturaValue;
        if(getFattura() != null){
            fatturaValue =  (getFattura().getPrefisso()!=null?getFattura().getPrefisso():"") + " " + getFattura().getNumero();
        }else{
            fatturaValue="";
        }
        return TO_STRING_MESSAGE_FORMAT.format
    ...
    public boolean equals(Object other) {
        if (!(other instanceof MROldRigaDocumentoFiscale)) {
            return false;
        }
        MROldRigaDocumentoFiscale castOther = (MROldRigaDocumentoFiscale) other;
