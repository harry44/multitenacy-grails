...
public class MROldRigaPrenotazionePPay implements it.aessepi.utils.db.PersistentInstance, MROldRigaDocumento {
    ...
    /** default constructor */
    public MROldRigaPrenotazionePPay() {
        setTempoKm(false);
        setTempoExtra(false);
        setFranchigia(false);
    }

    public MROldRigaPrenotazionePPay(MROldRigaDocumentoFiscale row, MROldPrenotazione res) {
    ...
    public boolean equals(Object other) {
        if (!(other instanceof MROldRigaPrenotazionePPay)) {
            return false;
        ...
        MROldRigaPrenotazionePPay castOther = (MROldRigaPrenotazionePPay) other;
