...
public class AvtaleGiroInformation {
    ...
    @XmlElementRef(name = "AvtaleGiroStatus", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> avtaleGiroStatus;
     ...
     *     
     */
    public JAXBElement<String> getAvtaleGiroStatus() {
     ...
     *     
     */
    public void setAvtaleGiroStatus(JAXBElement<String> value) {
