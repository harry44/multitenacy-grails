...
public class Fraud {
    ...
    @XmlElementRef(name = "PolicyName", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "AnalysisAction", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> analysisAction;
     ...
     *     
     */
    public JAXBElement<String> getAnalysisAction() {
     ...
     *     
     */
    public void setAnalysisAction(JAXBElement<String> value) {
