...
public class MobileInformation {
    ...
    @XmlElementRef(name = "LaunchURL", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> launchURL;
     ...
     *     
     */
    public JAXBElement<String> getLaunchURL() {
        return launchURL;
    }
     ...
     *     
     */
    public void setLaunchURL(JAXBElement<String> value) {
