...
public class ProcessRequest {
    ...
    @XmlElementRef(name = "TransactionAmount", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
