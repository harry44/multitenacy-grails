...
public class QueryResponse {
    ...
    @XmlElementRef(name = "ChildTransactionId", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> childTransactionId;
     ...
     *     
     */
    public JAXBElement<String> getChildTransactionId() {
     ...
     *     
     */
    public void setChildTransactionId(JAXBElement<String> value) {
