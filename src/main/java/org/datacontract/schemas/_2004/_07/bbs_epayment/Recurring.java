...
public class Recurring {
    ...
    @XmlElementRef(name = "Frequency", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "PanHashSecret", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> panHashSecret;
    @XmlElementRef(name = "PanhashType", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> panhashType;
    @XmlElementRef(name = "Type", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> type;
    @XmlElementRef(name = "Use3DS", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> use3DS;
     ...
     *     
     */
    public JAXBElement<String> getPanHashSecret() {
     ...
     *     
     */
    public void setPanHashSecret(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getPanhashType() {
        return panhashType;
    }
     ...
     *     
     */
    public void setPanhashType(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<String> getUse3DS() {
        return use3DS;
    }
     ...
     *     
     */
    public void setUse3DS(JAXBElement<String> value) {
        this.use3DS = value;
    }
