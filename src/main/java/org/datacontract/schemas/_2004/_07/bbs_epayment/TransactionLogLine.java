...
public class TransactionLogLine {
    ...
    @XmlElementRef(name = "CreditedAmount", namespace = "http://schemas.datacontract.org/2004/07/BBS.EPayment.ServiceLibrary", type = JAXBElement.class, required = false)
    protected JAXBElement<String> creditedAmount;
     ...
     *     
     */
    public JAXBElement<String> getCreditedAmount() {
     ...
     *     
     */
    public void setCreditedAmount(JAXBElement<String> value) {
